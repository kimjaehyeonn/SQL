...
-- -> insert 문 결과: int값(row 수)
-- insert 하나 할 때 마다 return 1.
...
-- INSERT INTO prodTbl VALUES ('A01', 'P100', '2023-02-01 13:00:00', 'JPY'); -- X (prodCode, prodID가 중복됨 )
...
-- 엔티티(대상)에 문제가 없는 데이터가 들어가게 됨
-- 개체 무결성(pk 설정해서 not null, unique 설정함)
INSERT INTO buyTBL (userID, prodName) VALUES ('USER001', '운동화');
INSERT INTO buyTBL (userID, prodName) VALUES ('USER002', '노트북');
INSERT INTO buyTBL (userID, prodName) VALUES ('USER002', '테레비');

SELECT *FROM buyTBL;

-- userId가 fk가 설정되어 있어서 원본테이블의 값과 동일한 값들이 들어가는지 자동체크해줌.
...
-- INSERT INTO userTBL VALUES ('USER003', '이영희', 1995, 'hong@example.com'); -- X (NOT UNIQUE)
...
-- INSERT INTO userTBL VALUES ('EFGH5678', NULL, 1980, '011'); -- CHECK ( NAME IS NOT NULL)
